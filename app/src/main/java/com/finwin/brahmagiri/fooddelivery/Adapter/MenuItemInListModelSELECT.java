...
public class MenuItemInListModelSELECT {
    Integer image;
    String itemID, itemName, itemDescp, itemAmount;

    public MenuItemInListModelSELECT(String _itemID, Integer _image, String _itemName, String _itemDescp, String _itemAmount) {
        this.itemID = _itemID;
        this.image = _image;
